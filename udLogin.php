...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $email_search = "select * from udregistration where email='$email'";
    ...
    <div class="card bg-light">
        <article class="card-body mx-auto" style="max-width: 400px;">
            <h4 class="card-title mt-3 text-center">Login To Your User Account</h4>
            ...
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                <p class="text-center">Don't have an account? <a href="udSign.php">Sign Up</a></p>
