...
<body>
    ...
    include 'link/dbcon.php';
        if(isset($_POST['submit'])){
            ...
            $emailquery = "select * from pdregistration where email= '$email'";
    ...
    <?php
                ...
                if($password=== $cpassword){
                   $insertquery = "insert into pdregistration(username, email, mobile, password, cpassword) values('$username','$email','$mobile','$pass','$cpass')";
    ...
    <div class="card bg-light">
        <article class="card-body mx-auto" style="max-width: 400px;">
            <h4 class="card-title mt-3 text-center">Create Provider Account</h4>
            ...
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
                ...
                <p class="text-center">Have an account? <a href="pdLogin.php">Log in</a></p>
            </form>
        </article>
    </div>
